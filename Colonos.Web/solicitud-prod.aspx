<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="solicitud-prod.aspx.cs" Inherits="Colonos.Web.solicitud_prod" %>
                                    ...
                                    <div class="row" style="height: 50vh;overflow: auto;">
                                        <asp:GridView ID="gvResultado" runat="server"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Tiene Receta">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblTieneReceta" runat="server" Text='<%# Eval("TieneReceta")%>' />
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Precio Volumen" Visible="false" HeaderStyle-HorizontalAlign="Right">
                                                    <ItemTemplate>
                ...
                <ContentTemplate>
                    <div class="card card-top" >
                        ...
                        <div class="card-body overflow-auto">
                            <nav class="navbar navbar-expand-lg navbar-light nav-toolbar" style="height: 55px;">
                                <div class="container-fluid">
                                    <ul class="navbar-nav">
                                        <li class="nav-item">
                                            <asp:LinkButton ID="btnVolver" CssClass="btn btn-nav" runat="server" PostBackUrl="/bandeja-produccion.aspx" ><i class="fas fa-reply p-1"></i>Volver</asp:LinkButton>
                                        </li>
                                        <li class="nav-item">
