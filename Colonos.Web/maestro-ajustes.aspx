<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="maestro-ajustes.aspx.cs" Inherits="Colonos.Web.maestro_ajustes" %>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Candidad" >
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="NumericOnlyValidator" runat="server" ControlToValidate="txtCantidad" ErrorMessage="valor incorrecto" CssClass="d-block" ForeColor="Red" ValidationExpression="^((?:[1-9]\d*)|(?:(?=[\d.]+)(?:[1-9]\d*|0).\d+))$"></asp:RegularExpressionValidator>
                                                    </ItemTemplate>
                        ...
                        <div class="card-body overflow-auto">
                            <nav class="navbar navbar-expand-lg navbar-light nav-toolbar mb-2" style="height: 55px;">
                                <div class="container-fluid">
                                    <ul class="navbar-nav">
                                        <li class="nav-item">
                                            <asp:LinkButton ID="btnNuevo" CssClass="btn btn-nav" runat="server" OnClick="Nuevo_Event" ><i class="far fa-file p-1"></i>Nuevo</asp:LinkButton>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <div>
                                <div>
                                    <div class="row mb-2">
                                        <div class="col-sm-4">
                                            <div class="input-group input-group-sm mb-1"><span class="input-group-text label-caption">Tipo Transacción</span>
                                                <asp:DropDownList ID="cboTipoTransaccion" runat="server" CssClass="form-select">
                                                    <asp:ListItem Value="0" Text=""></asp:ListItem>
                                                    <asp:ListItem Value="401" Text="Ajuste Egreso"></asp:ListItem>
                                                    <asp:ListItem Value="402" Text="Ajuste Ingreso"></asp:ListItem>
                                                    <asp:ListItem Value="403" Text="Traslado"></asp:ListItem>
                                                </asp:DropDownList></div>
                                            <div class="input-group input-group-sm mb-1"><span class="input-group-text label-caption">Bodega Origen</span><asp:DropDownList ID="cboBodegaOrigen" runat="server" CssClass="form-select"></asp:DropDownList></div>
                                            <div class="input-group input-group-sm mb-1"><span class="input-group-text label-caption">Bodega Destino</span><asp:DropDownList ID="cboBodegaDestino" runat="server" CssClass="form-select"></asp:DropDownList></div>
                                            <div class="input-group input-group-sm mb-1"><span class="input-group-text label-caption">Glosa</span><asp:TextBox ID="txtGlosa" runat="server" CssClass="form-control" placeholder="glosa"></asp:TextBox></div>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-sm-12">
