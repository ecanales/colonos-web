<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="mantenedor-familia.aspx.cs" Inherits="Colonos.Web.mantenedor_familia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!-- INI POPUP FAMILIA -->
    <asp:Panel ID="pnlFamilia" runat="server" Style="display: none; width:50%;max-width:800px;min-width:500px;">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-3" style="max-height: 500px; min-height: 200px;">
                                <div class="row justify-content-center">
                                    <div class="col-sm-8">
                                        <div class="input-group input-group-sm mb-1"><span class="input-group-text label-caption">Id</span><asp:TextBox ID="txtFamiliaCode" runat="server" ReadOnly="true" CssClass="form-control" ></asp:TextBox></div>
                                        <div class="input-group input-group-sm mb-1"><span class="input-group-text label-caption">Nombre</span><asp:TextBox ID="txtFamiliaNombre" runat="server" CssClass="form-control text-end" ></asp:TextBox></div>
                        ...
                        <div class="card-body">
                            <nav class="navbar navbar-expand-lg navbar-light nav-toolbar">
                              <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="mynavbar">
                                    ...
                                    <ul class="navbar-nav">
                                      <li class="nav-item">
                                          <asp:LinkButton ID="btnActualizar" runat="server" CssClass="btn" ForeColor="white" OnClick="Actualizar_Event"><i class="fas fa-sync-alt p-1"></i>Actualizar</asp:LinkButton>
                                          <asp:LinkButton ID="btnNuevo" runat="server" CssClass="btn btn-danger" OnClick="Nuevo_Event"><i class="far fa-file p-1"></i>Nuevo</asp:LinkButton>
                                      </li>
                                      <li class="nav-item">
                            ...
                            <div class="table-responsive p-1" style="font-size: 13px; border-top: 2px solid black; overflow-y: auto;height: calc(90vh - 300px);">
                                <asp:GridView ID="gvList"
                                    ...
                                    >
                                    <Columns>
                                        <asp:TemplateField HeaderText="FamiliaCode"         HeaderStyle-CssClass="" Visible="false"><ItemTemplate><asp:Label ID="lblFamiliaCode"  runat="server" Text='<%# Eval("FamiliaCode") %>' /></ItemTemplate> <ItemStyle HorizontalAlign="Left" Width="0%"></ItemStyle></asp:TemplateField>
                                        <asp:TemplateField HeaderText="Nombre Familia" HeaderStyle-CssClass=""><ItemTemplate><asp:LinkButton ID="lblFamiliaNombre" OnClick="Editar_Event"  runat="server"  Text='<%# Eval("FamiliaNombre") %>' /></ItemTemplate><ItemStyle HorizontalAlign="Left" Width="20%"></ItemStyle></asp:TemplateField>
    ...
    <cc1:ModalPopupExtender
        ID="popupFamilia" runat="server"
        DropShadow="false"
        PopupControlID="pnlFamilia"
